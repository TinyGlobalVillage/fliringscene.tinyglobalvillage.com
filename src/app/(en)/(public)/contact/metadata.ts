...
export const metadata = {
  ...
  openGraph: {
    ...
    url: "https://fliringscene.tinyglobalvillage.com/contact",
  ...
  twitter: {
    ...
    title: "Contact Us | Fliring Scene – Get in Touch",
    description: "Send us a message or ask about performing. Fliring Scene welcomes fresh talent and curious minds.",
